...
def main():
    ...
    for i in range(num_games):
        ...
        # final_candidates_output_path = f'./output/final_candidates_{time_info}.json'

        create_records(final_candidates, **words_dict)

        # pd.DataFrame(game_record).to_json(game_record_output_path, orient='records')
    ...
    # clues_output_path = f'./output/output_{time_info}.csv'
    # output.to_csv(clues_output_path)
